...
const AddRadiology = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        console.log("Radiology Data:", info);
        alert("Radiology added successfully!");
    };
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600">
                        Complete the form below to register a medical Radiology
                    </p>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="mb-4">
                                <label className="block text-sm font-medium text-gray-700 mb-2">
                                    Radiology Name <span className="text-red-500">*</span>
                                </label>
                                <input
                                    type="text"
                                    required
                        ...
                        <div>
                            ...
                            <div className="mb-4">
                                <label className="block text-sm font-medium text-gray-700 mb-2">
                                    Radiology License Number <span className="text-red-500">*</span>
                                </label>
                                <input
                                    type="text"
                                    required
                                    ...
                                    value={info.RadiologyLicense}
                                    onChange={(e) =>
                                        setInfo({ ...info, RadiologyLicense: e.target.value })
                                    }
                                />
                            </div>
                            ...
                            <div className="mt-4">
                                ...
                                <textarea
                                    ...
                                    placeholder="Describe the Radiology services..."
